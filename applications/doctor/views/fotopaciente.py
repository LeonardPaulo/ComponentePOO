    ...
    try:
        ...
        context = {
            ...
            "permissions": {
                ...
                "change_fotopaciente": request.user.has_perm(
                    "core.change_fotopaciente"
                ),
                "delete_fotopaciente": request.user.has_perm(
                    "core.delete_fotopaciente"
                ),
        ...
        messages.error(request, f"Error al cargar las fotos: {str(e)}")
        return render(
            request,
            "doctor/fotos_paciente/list.html",
            {
                "title": "Listado de Fotos de Paciente",
                "title1": "Fotos de Pacientes",
                "page_obj": [],
                "permissions": {
                    ...
                    "view_fotopaciente": request.user.has_perm(
                        "core.view_fotopaciente"
                    ),
                },
            },
        )
